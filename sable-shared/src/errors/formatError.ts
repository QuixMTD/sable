...
//
// The Stripe branch is duck-typed on shape only — no runtime Stripe import —
// so services that never touch Stripe (sable-sc, sable-re, …) pay nothing
// for keeping the branch here.
